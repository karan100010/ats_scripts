...
asr_model_en =nemo_asr.models.EncDecCTCModelBPE.from_pretrained(model_name="nvidia/parakeet-ctc-0.6b")
...
def convert_ulaw_to_wave():
     ...
     #   print(ulaw_fragments)
        ...
        os.remove(file)
        data={"text":text}
        response= requests.post("http://172.16.1.209:5014/extract",json=data)
        print(response.text)
