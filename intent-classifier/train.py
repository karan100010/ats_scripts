...
def tokenize_dataset(df):
    return tokenizer(df['instruction'].tolist(), padding=True, truncation=True, return_tensors="pt")
...
c2l = ClassLabel(num_classes=num_classes, names=['change_shipping_address', 'track_order', 'edit_account', 'payment_issue', 'switch_account', 'contact_human_agent', 'place_order', 'delivery_options', 'newsletter_subscription', 'check_payment_methods', 'contact_customer_service', 'get_refund',
